...
`mouthpiece-round.py`, which checks every joint in both directions before it writes, and
numbered by `bell/number_rings.py`. `mouthpiece-cup-parts.svg`, from `mouthpiece-cup.py`,
is the cup that stacks on its end. Its
...
`mouthpiece-round-parts-section.svg`, `mouthpiece-cup-parts-section.svg` and
`mouthpiece-section.svg`, drawn by
