# Curved trumpet, without elbows

A **curved** trumpet bore in 25 × 25mm square section, built from eight box sections and
**no elbows at all**. It replaces the
[curved trumpet](https://github.com/Gernreich/trumpet-curved), which turned the bore with
single-block elbows; this one turns it inside the sections, so every joint is a flat face
glued to a flat face. Companion to the
...
**[Turn the bore around in your browser](trumpet-curved_no_elbows.html)** — drag to rotate,
...
cuts.** Blue lays the section number onto every part first; black frees it. Nothing here
uses the middle stages.
...
python3 bore_split.py ../../trumpet-curved_no_elbows/trumpet-curved_no_elbows.html \
    --write ../../trumpet-curved_no_elbows
```
