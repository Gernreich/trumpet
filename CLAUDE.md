...
thing. The bore's cut files are generated by **`../../octomino-snakes`**, which sits above
`GIT` rather than beside this repository and is archived — read-only on GitHub, still
runnable here — and this repository holds its output. The bell and the mouthpiece have
their own generators here.
...
cd $S && python3 bore_split.py \
    ../../GIT/trumpet-coiled/bore/bore.html \
    --write ../../GIT/trumpet-coiled/bore
```
