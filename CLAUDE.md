...
- **Name the sheet on the way out.** Both generators take the filename — a positional
  ...
  the bore in every one: `mouthpiece-bore25-trumpet-parts.svg`, `bell-square10-153mm-17rings-x3-rim86.svg`. The
...
- **A bare `bell-round.py` writes `bell-square25-204mm-17rings-x4-rim145.svg` back into `../trumpet-parts/bell`,**
