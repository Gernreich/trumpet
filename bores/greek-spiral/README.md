...
and brought back out beside itself. **This repository is the bore**: one
...
<!-- readme-only -->
**[Read the writeup](https://gernreich.github.io/greek-spiral/)** — the same
text as this page, set for reading, with a table of contents.

**[The repository](https://github.com/Gernreich/greek-spiral)** — the bore and
the page it regenerates from.

**[Download everything as a ZIP](https://github.com/Gernreich/greek-spiral/archive/refs/heads/main.zip)**
...
it the way [trumpet-switchback](https://github.com/Gernreich/trumpet-switchback)
...
[trumpet-switchback](https://github.com/Gernreich/trumpet-switchback) uses, and
...
Generated by
**[bore-generator](https://github.com/Gernreich/bore-generator)**. Its
...
~/boxes/venv/bin/python bore_split.py --blocksize=16 --refuse-elbows "$W" --write ../greek-spiral/bore
~/boxes/venv/bin/python check.py --blocksize=16 "$W" --files ../greek-spiral/bore
```
