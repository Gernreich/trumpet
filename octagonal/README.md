...
```sh
python3 ../parts/bore/concept/swept-curve/ribbon_view.py --shape=torus --facet=45 --bore=25 \
...
The numbers live in
[`bores/ribbon/traces/octagonal-trumpet.json`](../parts/bore/concept/swept-curve/traces/octagonal-trumpet.json)
