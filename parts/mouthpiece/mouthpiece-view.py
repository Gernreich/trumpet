...
# Named after the SOURCE, so the drawing and the sheet it came from carry one name --
# it was a fixed "mouthpiece-view.svg", which said nothing about which mouthpiece and did
# not match the shipped drawing's own name.
out = sys.argv[1] if len(sys.argv) > 1 else display_out(SRC, "-view.svg")
